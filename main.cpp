...
const string studentData[] = {
    ...
    "A5,Afaq,Ahmad,afaq123@wgu.edu,24,40,35,30,SOFTWARE"
};
...
Roster classRoster;
 ...
 for (int i = 0; i < 5; i++)
 {
 //create a string stream and hold the studentData table at index
 ...
 classRoster.add(student[0], student[1], student[2], student[3],
stoi(student[4]), stoi(student[5]),
...
endl;
 ...
 cout << "Student Name: Afaq Ahmad" << endl;
 cout << "-------------------------------------------------------" <<
endl;
 cout << endl;
 //Call Methods below
...
classRoster.printByDegreeProgram(DegreeProgram::SOFTWARE); // Call the method printByDegreeProgram
