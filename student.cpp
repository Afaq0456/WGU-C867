...
#include "degree.h"//Allows the use of Student methods
#include <iostream>//USE COUT and CIN
using namespace std;
Student::Student() {} //Constructor
Student::Student(string studentID, string fName, string lName, string
emailAddr, int age,
...
void Student::print()
{
 ...
 cout << "daysInCourse: " << numDays[0] << ", " << numDays[1] << ", "
<< numDays[2] << endl; // displays days in course display 3 days
 cout << "Degree Program: " << degreeProgramToString(degree) << endl; // Convert enum to string
    cout << endl;
}//End Student::print
